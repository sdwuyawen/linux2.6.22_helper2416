...
static struct s3c24xx_pcm_dma_params s3c24xx_i2s_pcm_stereo_out = {
	...
	.dma_addr	= S3C6410_PA_IIS_V40 + S3C2410_IISFIFO,
	.dma_size	= 4,
};
...
static struct s3c24xx_pcm_dma_params s3c24xx_i2s_pcm_stereo_in = {
	...
	.dma_addr	= S3C6410_PA_IIS_V40 + S3C2410_IISFIFORX,
	.dma_size	= 4,
};
				...
				struct snd_pcm_hw_params *params)
{
	...
	case SNDRV_PCM_FORMAT_S16_LE:
		...
		iismod |= S3C_IIS0MOD_256FS | S3C_IIS0MOD_32FS;
		iismod &= ~(0x3<<13);
...
static int s3c_i2s_v40_probe(struct platform_device *pdev)
{
	...
	s3c24xx_i2s.regs = ioremap(S3C6410_PA_IIS_V40, 0x100);
