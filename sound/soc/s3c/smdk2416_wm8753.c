...
static struct snd_soc_dai_link smdk6400_dai[] = {			/* 绑定Codec驱动和Soc驱动 */
{ /* Hifi Playback - for similatious use with voice below */
	.name = "WM8753",
	.stream_name = "WM8753 HiFi",
	.cpu_dai = &s3c_i2s_dai,							/* Soc的DAI */
	.codec_dai = &wm8753_dai[WM8753_DAI_HIFI],		/* Codec的DAI */
	.init = smdk6400_wm8753_init,						/* codec/machine特定的初始化 */
	.ops = &smdk6400_hifi_ops,						/* 板流操作 */
},
};
...
/* 作为platform_device的私有数据，对一个ASoC设备的整体封装 */
...
static int __init smdk6400_init(void)
{
	...
	/* 设置platform_device的私有数据,&smdk6400_snd_devdata */
