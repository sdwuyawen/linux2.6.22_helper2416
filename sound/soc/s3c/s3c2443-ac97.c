...
static int s3c2443_ac97_hifi_prepare(struct snd_pcm_substream *substream)
{
	/* Set for defult Volume */
	s3c2443_ac97_write(0, 0x18, 0x606); /* Headphone Volume */
	s3c2443_ac97_write(0, 0x4 , 0x606); /* PCM Out Volume */
	return 0;
}
...
struct snd_soc_cpu_dai s3c24xx_ac97_dai[] = {
{
	...
	.ops = {
		...
		.prepare = s3c2443_ac97_hifi_prepare,
