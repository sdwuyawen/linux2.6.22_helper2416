		 ...
		 int baud, int parity, int bits, int flow)
{
	...
	/********* add here *********/
	putstring_VA("uart_set_options() 1\r\n");
	/********* end add *********/
	...
	/********* add here *********/
	putstring_VA("uart_set_options() 2\r\n");
	/********* end add *********/

	port->ops->set_termios(port, &termios, NULL);	/* s3c24xx_serial_set_termios()这里没过去 */
	co->cflag = termios.c_cflag;

	/********* add here *********/
	putstring_VA("uart_set_options() 3\r\n");
	/********* end add *********/
