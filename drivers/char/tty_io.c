...
void __init console_init(void)
{
	...
	/********* add here *********/
	putstring_VA("console_init()\r\n");
	putstring_VA("__con_initcall_start=");
	putinthex_VA(__con_initcall_start);
	putstring_VA("__con_initcall_end=");
	putinthex_VA(__con_initcall_end);
	/********* end add *********/
	...
	/********* add here *********/
	putstring_VA("end of console_init()\r\n");
	/********* end add *********/
